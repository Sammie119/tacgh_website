            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title float-left align-middle">Prayer Request List</h3>
                    </div>
                    <!-- /.card-header -->
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="/prayer-forms/{{ $form->id }}" class="btn btn-sm btn-info"><i class="nav-icon fas fa-eye"></i></a>
                                </td>
                            </tr>
                            @empty
                                <tr>
